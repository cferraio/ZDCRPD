...
//static const double theZSectionBoundaries[] = {-500.0,-395.55,-353.5,-290.0};
static const double theZSectionBoundaries[] = {-500.0,-348.5,-290.0}; //changed to hold RPD {EM, RPD, HAD}, respectively
...
/** theXRPDChannelBoundaries are the x-low limits for each channel (RPD section)
 theYRPDChannelBoundaries are the y-low limits for each channel (RPD section) 
 Will McBrayer, July 2015. 
 **/
static const double theXrpdChannelBoundaries[] = {-50.0,-25.0,0.0,25.00};
static const double theYrpdChannelBoundaries[] = {-62.5,-32.25,0.0,32.25};
#endif
